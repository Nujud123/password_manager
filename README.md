...
5. Streamlit library to create interactive web applications in Python easily
Accounts & Passwords are grouped together using dictionary data type. 

## Functions:
1. apply_custom_style
2. load_passwords
3. save_passwords
4. evaluate_password
5. password_generator
6. get_logo_base64
7. create_master_password
8. login_screen
9. add_password_ui
10. update_password_ui
11. delete_password_ui
12. generate_password_ui
13. view_passwords_ui
14. main
